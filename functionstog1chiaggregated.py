# Fabian Kaechele
""" functions for basic overall test and aggreageted version of chi-squared test
                        """
...
def Chitest(alphatotal, first,second , n1, n2, Fenster, h, abgelehnt):
    """    Berechnet Teststatistik fuer jedes Fenster und vergleicht mit kritischem Wert. Falls zu wenig daten in Zelle, werden die Zellen aggregiert
